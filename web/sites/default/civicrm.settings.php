...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://surfershealing:5urf2Heal%21@mysql.surfershealing.dreamhosters.com/surfershealing_d10?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://d10.surfershealing.org//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/home/isrpas/d10.surfershealing.org/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://surfershealing:5urf2Heal%21@mysql.surfershealing.dreamhosters.com/surfershealing_d10?new_link=true');
  }
}
...
$civicrm_root = '/home/isrpas/d10.surfershealing.org/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/isrpas/d10.surfershealing.org/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://d10.surfershealing.org');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'zUxFBVJhjriEmnv7zabSP86ulFJLbqzjrhvXeVwqWpM');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:jLtOodv58KbFeZnh05KjYHLzY9qO5EuZ2CbhxDVzIMwC1ypkQ');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', 'lLNSoauQyUVv0w');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:TUSkLqWVc04BlolcgKQxgd2AQXyF8rLBrMeZxQywXzwX0HPAPxw');
...
// define( 'CIVICRM_MAIL_LOG', '/home/isrpas/d10.surfershealing.org/web/sites/default/files/civicrm/templates_c/mail.log');
// }
