<?php /* Smarty version 2.6.32, created on 2023-11-14 09:57:24
         compiled from CRM/Profile/Form/Dynamic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Profile/Form/Dynamic.tpl', 1, false),array('block', 'crmRegion', 'CRM/Profile/Form/Dynamic.tpl', 11, false),array('block', 'icon', 'CRM/Profile/Form/Dynamic.tpl', 17, false),array('block', 'ts', 'CRM/Profile/Form/Dynamic.tpl', 18, false),array('modifier', 'truncate', 'CRM/Profile/Form/Dynamic.tpl', 35, false),array('modifier', 'substr', 'CRM/Profile/Form/Dynamic.tpl', 131, false),array('modifier', 'cat', 'CRM/Profile/Form/Dynamic.tpl', 132, false),array('modifier', 'replace', 'CRM/Profile/Form/Dynamic.tpl', 149, false),)), $this); ?>
...
<div class="messages status no-popup">
  ...
  <div class="crm-submit-buttons">
    <?php echo $this->_tpl_vars['form']['_qf_Edit_upload_delete']['html']; ?>
...
">
  ...
  <?php if ($this->_tpl_vars['showSaveDuplicateButton']): ?>
    <div class="crm-submit-buttons">
      <?php echo $this->_tpl_vars['form']['_qf_Edit_upload_duplicate']['html']; ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php elseif (((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 5) : substr($_tmp, 0, 5)) == 'phone'): ?><?php echo ''; ?><?php $this->assign('phone_ext_field', ((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'phone', 'phone_ext') : smarty_modifier_replace($_tmp, 'phone', 'phone_ext'))); ?><?php echo ''; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']): ?><?php echo '&nbsp;'; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['html_type'] != 'File' || ( $this->_tpl_vars['field']['html_type'] == 'File' && ! $this->_tpl_vars['field']['is_view'] )): ?><?php echo ''; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['html_type'] == 'Autocomplete-Select'): ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['data_type'] == 'ContactReference'): ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</div><div class="clear"></div></div>'; ?><?php if ($this->_tpl_vars['form'][$this->_tpl_vars['n']]['type'] == 'file'): ?><?php echo '<div class="crm-section file_displayURL-section file_displayURL'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section"><div class="content">'; ?><?php echo $this->_tpl_vars['customFiles'][$this->_tpl_vars['n']]['displayURL']; ?><?php echo '</div></div>'; ?><?php if (! $this->_tpl_vars['fields'][$this->_tpl_vars['n']]['is_view']): ?><?php echo '<div class="crm-section file_deleteURL-section file_deleteURL'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section"><div class="content">'; ?><?php echo $this->_tpl_vars['customFiles'][$this->_tpl_vars['n']]['deleteURL']; ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['help_post'] && $this->_tpl_vars['action'] != 4 && $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']): ?><?php echo '<div class="crm-section helprow-'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section helprow-post" id="helprow-'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '"><div class="content description">'; ?><?php echo $this->_tpl_vars['field']['help_post']; ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['groupHelpPost']): ?><?php echo '<div class="messages help">'; ?><?php echo $this->_tpl_vars['field']['groupHelpPost']; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['mode'] != 8 && $this->_tpl_vars['mode'] != 4): ?><?php echo '</fieldset></div>'; ?><?php endif; ?><?php echo ''; ?><?php if (( $this->_tpl_vars['action'] == 1 && $this->_tpl_vars['mode'] == 4 ) || ( $this->_tpl_vars['action'] == 2 ) || ( $this->_tpl_vars['action'] == 8192 )): ?><?php echo ''; ?><?php if ($this->_tpl_vars['action'] == 2 && $this->_tpl_vars['multiRecordFieldListing']): ?><?php echo '<div class="crm-multi-record-custom-field-listing">'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php $this->assign('floatStyle', 'float:right'); ?><?php echo '</div>'; ?><?php endif; ?><?php echo '<div class="crm-submit-buttons" style=\''; ?><?php echo $this->_tpl_vars['floatStyle']; ?><?php echo '\'>'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/common/formButtons.tpl", 'smarty_include_vars' => array('location' => '')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php if ($this->_tpl_vars['showSaveDuplicateButton']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['form']['_qf_Edit_upload_duplicate']['html']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['includeCancelButton']): ?><?php echo '<a class="button cancel" href="'; ?><?php echo $this->_tpl_vars['cancelURL']; ?><?php echo '"><span><i class="crm-i fa-times" aria-hidden="true"></i>'; ?><?php echo $this->_tpl_vars['cancelButtonText']; ?><?php echo '</span></a>'; ?><?php endif; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?>
